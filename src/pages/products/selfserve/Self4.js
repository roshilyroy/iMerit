...
import classes from './self4.module.css';
import Button from '@mui/material/Button';

function Slide6() {
  return (
    <div className={classes.selfslide6}>
        <div className={classes.gradientbar}></div>
        <h2>GETTING</h2>
        <h1>STARTED!</h1>
        <p>The need for speed in high-quality data annotation has never been greater. iMerit combines the best of predictive and automated annotation technology with world-class data annotation and subject matter 
            experts to deliver the data you need to get to production, fast.</p>
