...
import './VideoNinethSection.css'
function VideoNinethSection() {
  return (
    <div className='tenthContainer'>
        <div className='container'>
            ...
            <div className='row'>
                <h1 className='tenthHead'>GETTING STARTED !</h1>
            </div>
            <div className='row'>
                <p className='tenthPara'>The need for speed in high-quality video annotation has never been greater. iMerit combines the best predictive and automated annotation technology with world-class data annotation experts and subject matter experts to deliver the data you need to get to production, fast.</p>
            </div>
            <div className=' asvg'>
            <a href='#' className='tenthA'>LET'S CONNECT</a>
...
export default VideoNinethSection
