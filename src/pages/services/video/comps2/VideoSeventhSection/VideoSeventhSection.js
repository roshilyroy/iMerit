...
import './VideoSeventhSection.css'
import Aos from 'aos';
import 'aos/dist/aos.css';
import CountUp from 'react-countup';
function VideoSeventhSection() {
    useEffect(() => {
  ...
  return (
    <div className='seventhContainer'>
      <div className='container'>
        <div className='row'>
            <h1 className='seventhHead'>VIDEO ANNOTATION IN NUMBERS</h1>
        </div>
        <div className='row'>
            <div className='sec11'>
                <div className='col-md-6 col-12'>
                    ...
                    <div className='gradientline1'>.</div>
                        <p data-aos='fade-up' className='sec11para1'data-aos-delay='200'>VIDEO DATA POINTS ANNOTATED</p>
                </div>
                <div className='col-md-6 col-12'>
...
export default VideoSeventhSection
