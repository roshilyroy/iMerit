...
function Fourcontent() {
  return (
    ...
    <Grid item xs={1}></Grid>
    <Grid item xs={10}>
        <h1 className='Sixheadsentcon'>GETTING STARTED WITH CONTENT MODERATION</h1>
        <p className='sixtxtcontent'>The need for speed in high-quality content moderation services has never been greater. iMerit combines the best predictive and automated annotation technology with world-class data annotation and subject matter experts to deliver the data you need to get to production, fast.
