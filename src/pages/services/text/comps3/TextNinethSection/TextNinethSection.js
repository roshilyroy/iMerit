...
import './TextNinethSection.css'
function TextNinethSection() {
  return (
    ...
    <div className='container'>
        ...
        <div className='row'>
            <h1 className='tenthHeadText'>GETTING STARTED WITH TEXT ANNOTATION</h1>
        </div>
        <div className='row'>
            <p className='tenthParaText'>The need for speed in high-quality text annotation has never been greater. iMerit combines the best predictive and automated annotation technology with world-class data annotation and subject matter experts to deliver the data you need to get to production, fast.</p>
        </div>
...
export default TextNinethSection
