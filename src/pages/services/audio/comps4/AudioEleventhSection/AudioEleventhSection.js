...
import './AudioEleventhSection.css'
function AudioEleventhSection() {
  return (
    ...
    <div className='container'>
        ...
        <div className='row'>
            <h1 className='tenthHeadAudio'>GETTING STARTED WITH AUDIO TRANSCRIPTION</h1>
        </div>
        <div className='row'>
            <p className='tenthParaAudio'>The need for speed in high-quality audio transcription has never been greater. iMerit combines the best predictive and automated transcription technology with world-class data transcription and subject matter experts to deliver the data you need to get to production, fast.</p>
        </div>
...
export default AudioEleventhSection
