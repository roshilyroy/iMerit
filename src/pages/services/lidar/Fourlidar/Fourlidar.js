...
function Fourlidar() {
  return (
    ...
    <Grid item xs={1}></Grid>
    <Grid item xs={10}>
        <h1 className='Sixheadlidar'>GETTING STARTED WITH LIDAR ANNOTATION</h1>
        <p className='sixtxt'>The need for speed in high-quality Lidar annotation has never been greater. iMerit combines the best predictive and automated annotation technology with world-class data annotation and subject matter experts to deliver the data you need to get to production, fast.
